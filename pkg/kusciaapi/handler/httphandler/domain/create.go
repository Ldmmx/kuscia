...
func NewCreateDomainHandler(domainService service.IDomainService) api.ProtoHandler {
...
func (h createDomainHandler) Handle(context *api.BizContext, request api.ProtoRequest) api.ProtoResponse {
	createRequest, _ := request.(*kusciaapi.CreateDomainRequest)
	return h.domainService.CreateDomain(context.Context, createRequest)
}

func (h createDomainHandler) GetType() (reqType, respType reflect.Type) {
	return reflect.TypeOf(kusciaapi.CreateDomainRequest{}), reflect.TypeOf(kusciaapi.CreateDomainResponse{})
}
