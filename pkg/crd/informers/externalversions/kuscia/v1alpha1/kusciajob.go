...
// KusciaJobInformer provides access to a shared informer and lister for
// KusciaJobs.
...
func (f *kusciaJobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kusciav1alpha1.KusciaJob{}, f.defaultInformer)
}

func (f *kusciaJobInformer) Lister() v1alpha1.KusciaJobLister {
	return v1alpha1.NewKusciaJobLister(f.Informer().GetIndexer())
}
