...
// KusciaTaskInformer provides access to a shared informer and lister for
// KusciaTasks.
...
func (f *kusciaTaskInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kusciav1alpha1.KusciaTask{}, f.defaultInformer)
}

func (f *kusciaTaskInformer) Lister() v1alpha1.KusciaTaskLister {
	return v1alpha1.NewKusciaTaskLister(f.Informer().GetIndexer())
}
