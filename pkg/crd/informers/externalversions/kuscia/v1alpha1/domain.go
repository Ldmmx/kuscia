	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KusciaV1alpha1().Domains().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KusciaV1alpha1().Domains().Watch(context.TODO(), options)
			},
		},
		&kusciav1alpha1.Domain{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *domainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kusciav1alpha1.Domain{}, f.defaultInformer)
}
