...
// KusciaTaskLister helps list KusciaTasks.
// All objects returned here must be treated as read-only.
type KusciaTaskLister interface {
...
// kusciaTaskLister implements the KusciaTaskLister interface.
type kusciaTaskLister struct {
	indexer cache.Indexer
}

// NewKusciaTaskLister returns a new KusciaTaskLister.
func NewKusciaTaskLister(indexer cache.Indexer) KusciaTaskLister {
	return &kusciaTaskLister{indexer: indexer}
}

// List lists all KusciaTasks in the indexer.
func (s *kusciaTaskLister) List(selector labels.Selector) (ret []*v1alpha1.KusciaTask, err error) {
...
func (s kusciaTaskNamespaceLister) Get(name string) (*v1alpha1.KusciaTask, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("kusciatask"), name)
	}
	return obj.(*v1alpha1.KusciaTask), nil
}
