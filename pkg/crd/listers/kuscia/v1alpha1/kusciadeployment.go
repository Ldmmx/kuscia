...
// KusciaDeploymentLister helps list KusciaDeployments.
// All objects returned here must be treated as read-only.
type KusciaDeploymentLister interface {
...
// kusciaDeploymentLister implements the KusciaDeploymentLister interface.
type kusciaDeploymentLister struct {
...
func NewKusciaDeploymentLister(indexer cache.Indexer) KusciaDeploymentLister {
	return &kusciaDeploymentLister{indexer: indexer}
}

// List lists all KusciaDeployments in the indexer.
func (s *kusciaDeploymentLister) List(selector labels.Selector) (ret []*v1alpha1.KusciaDeployment, err error) {
...
func (s kusciaDeploymentNamespaceLister) Get(name string) (*v1alpha1.KusciaDeployment, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("kusciadeployment"), name)
	}
	return obj.(*v1alpha1.KusciaDeployment), nil
}
