...
func (in *Container) DeepCopyInto(out *Container) {
	*out = *in
	...
	if in.MetricProbe != nil {
		in, out := &in.MetricProbe, &out.MetricProbe
		*out = new(MetricProbe)
		**out = **in
	}
...
func (in *KusciaTaskStatus) DeepCopyInto(out *KusciaTaskStatus) {
	*out = *in
	...
	if in.AllocatedPorts != nil {
		...
		*out = make([]PartyAllocatedPorts, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *KusciaTaskSummaryStatus) DeepCopyInto(out *KusciaTaskSummaryStatus) {
	*out = *in
	...
	if in.ResourceStatus != nil {
		...
		*out = make(map[string][]*TaskSummaryResourceStatus, len(*in))
		for key, val := range *in {
			var outVal []*TaskSummaryResourceStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = make([]*TaskSummaryResourceStatus, len(*in))
				for i := range *in {
					if (*in)[i] != nil {
						in, out := &(*in)[i], &(*out)[i]
						*out = new(TaskSummaryResourceStatus)
						(*in).DeepCopyInto(*out)
					}
				}
			}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricProbe) DeepCopyInto(out *MetricProbe) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricProbe.
func (in *MetricProbe) DeepCopy() *MetricProbe {
	if in == nil {
		return nil
	}
	out := new(MetricProbe)
...
func (in *TaskResourceGroupSpec) DeepCopyInto(out *TaskResourceGroupSpec) {
	*out = *in
	...
	if in.OutOfControlledParties != nil {
		in, out := &in.OutOfControlledParties, &out.OutOfControlledParties
		*out = make([]TaskResourceGroupParty, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *TaskSummaryResourceStatus) DeepCopyInto(out *TaskSummaryResourceStatus) {
	*out = *in
	in.TaskResourceStatus.DeepCopyInto(&out.TaskResourceStatus)
	return
}
